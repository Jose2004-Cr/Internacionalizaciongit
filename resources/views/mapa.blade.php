            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="bg-white rounded shadow col-md-5 scrollable-table">
                        <h2 class="mb-3 text-center text-primary fw-bold">Usuarios por país</h2> <input type="text"
                            id="search" class="form-control search-bar" placeholder="Buscar por país...">
                        ...
                        <div id="pagination" class="mb-3 d-flex justify-content-center"> <button id="prev"
                                class="pagination-button me-2">Anterior <- </button> <button id="next"
                                        class="pagination-button">Siguiente -> </button> </div>
                    </div>
                    <div class="col-md-7">
