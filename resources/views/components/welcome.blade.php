...
<div id="estadisticas" style="display: block">
    ...
    <body class="bg-gray-100">
        <main class="container p-4 mx-auto">
            ...
            <div class="p-4 bg-white rounded-lg shadow">
                <h4 class="mb-4 text-xl font-semibold">#totals</h4>
            ...
            <div class="grid grid-cols-1 gap-4 mb-5 md:grid-cols-2">
                                    ...
                                    <div class="flex items-center justify-center">
                                        ...
                                        <div data-popover id="chart-info" role="tooltip"
                                            ...
                                            <div class="p-3 space-y-2">
                                                <h3 class="font-semibold text-gray-900 dark:text-white">Estadistica De
                                                    Tablas
                                                </h3>
                                                <p>Aqui se vera reflejado el porcentaje de estudiantes registrados en
                                                    los eventos realizados por la institucion universitaria, Tecnologico
                                                    Comfenalco, todo esto mostrado en el numero de meses.</p>
                                                <h3 class="font-semibold text-gray-900 dark:text-white">Table
                                                    Statistics</h3>
                                                <p>Here the percentage of students registered in the events held by the
                                                    university institution, Tecnologico Comfenalco, will be reflected,
                                                    all shown in the number of months.</p>
                                                <a href="#"
                ...
                <div class="p-4 bg-white rounded-lg shadow">
                    <h4 class="mb-4 text-xl font-semibold">Pie Diagram</h4>
                    <div id="chart-expenses" class="h-80"></div>
                </div>
            </div>
            ...
            <div class="mb-5">
                <div class="p-4 bg-white rounded-lg shadow">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="#!" class="text-sm text-blue-600 hover:text-blue-800">Exportar <i
            ...
            <div class="mb-5">
                <div class="p-4 bg-white rounded-lg shadow">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="#!" class="text-sm text-blue-600 hover:text-blue-800">Ver todas <i
                                data-feather="arrow-right" class="icon-xxs"></i></a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full text-left">
                            <thead class="bg-gray-50">
...
<div id="home" style="display: none">
    ...
    <div style="width: 100%; border: 1px solid #686767; padding: 100px; border-radius: 50px;">
        ...
        <button type="button"
            class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Blue</button>
    </div>
    <BR></BR>
    {{-- contenido de tabla --}}
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 w-10 h-10">
                            <img class="w-10 h-10 rounded-full" src="https://i.pravatar.cc/150?img=1" alt="">
                        </div>
                        <div class="ml-4">
