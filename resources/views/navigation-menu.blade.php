<nav x-data="{ open: false }" class="bg-white px-6 py-[10px] flex items-center justify-between shadow-sm">
    ...
    <div x-data="{ open: false }" @click.away="open = false" class="relative ml-3">
       ...
       <div x-show="open" class="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg">
    ...
    <div x-data="{ open: false }" @click.away="open = false" class="relative ml-3">
       ...
       <div x-show="open" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg">
          <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Edit Profile</a>
          <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Activity Log</a>
          <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Go Pro</a>
          <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Account Settings</a>
          <div class="border-t border-gray-100"></div>
          <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Sign Out</a>
       </div>
    </div>
 </nav>
